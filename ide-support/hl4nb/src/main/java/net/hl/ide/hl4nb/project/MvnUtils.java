...
public class MvnUtils {
    ...
    public static final MvnArtifact HADRA = new MvnArtifact("net.hl", "hadra-lang", "0.1.0"); // NOI18N
    public static final MvnArtifact HADRA_MAVEN_PLUGIN = new MvnArtifact("net.hl.build", "hadra-maven-plugin", "0.1.0"); // NOI18N
