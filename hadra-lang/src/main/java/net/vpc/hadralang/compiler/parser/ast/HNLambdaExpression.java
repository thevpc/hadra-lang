...
public class HNLambdaExpression extends HNode {
    ...
    public String toString() {
        ...
        if (arguments.size() > 0) {
            ...
            for (HNDeclareIdentifier argument : arguments) {
                ...
                if (argument.getIdentifierTypeName() != null) {
                    if (argument.isVarArg()) {
                        sb.append(argument.getIdentifierTypeName().componentType());
                        sb.append("...");
                        sb.append(" ");
                    } else {
                        sb.append(argument.getIdentifierTypeName());
                        sb.append(" ");
                    }
                }
    ...
    public HNLambdaExpression buildInvokable() {
        ...
        boolean varArg = getArguments().size() > 0 && getArguments().get(getArguments().size() - 1).getIdentifierTypeName().getTypename().isVarArg();
