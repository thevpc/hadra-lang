...
public class InterpolatedStringPartPattern extends AbstractTokenPattern {
    ...
    public InterpolatedStringPartPattern() {
    ...
    public class InterpolatedStringPartPatternMatcher extends AbstractJTokenMatcher {
        ...
        public InterpolatedStringPartPatternMatcher() {
            super(InterpolatedStringPartPattern.this.order());
        }

        @Override
        public JTokenPattern pattern() {
            return InterpolatedStringPartPattern.this;
        }
