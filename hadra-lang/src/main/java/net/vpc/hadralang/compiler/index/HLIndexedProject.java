...
public class HLIndexedProject implements HLIndexedElement {
    private String id;
    ...
    public HLIndexedProject(String id, String moduleId, String source, String[] dependencyIds,String[] dependencyFiles) {
        this.id = id;
