...
//import net.hl.compiler.utils.HLExtensionNames;
//import net.hl.compiler.utils.HPartitionHelper;
...
//
//import static net.hl.compiler.parser.ast.HNode.*;
//
...
//        if (t != null) {
//            JType r = t.rawType();
//            if (r.name().startsWith("net.hl.lang.Tuple")) {
...
//        if (t != null) {
//            JType r = t.rawType();
//            if (r.name().equals("net.hl.lang.TupleN")) {
//                throw new IllegalArgumentException("Fix me later");
//            } else if (r.name().startsWith("net.hl.lang.Tuple")) {
//                return Integer.parseInt(r.name().substring("net.hl.lang.Tuple".length()));
//            } else {
//                //not a tuple
//                return -1;
//            }
...
//                    }
//                    if (compilerContext.isStage(STAGE_3_WIRE_CALLS)) {
//                        JType branchesArrayType = context.types().forName("net.hl.lang.Branch<" + upperBoundCond.getType().name()
//                                + ","
