                ...
                if (a.isIteratorType()) {
                    ...
                    if (initExpr instanceof HNDeclareIdentifier) {
                        ...
                        if(identifierToken instanceof HNDeclareTokenIdentifier) {
                            ...
                            Iterable iter = iter(initValue, null/**TODO i.getInitValueConstraint()*/);
                            if (iter == null) {
                            ...
                            if (obj instanceof Tuple) {
                                ...
                                for (int ii = identifiers.length - 1; ii >= 0; ii--) {
                                    if (ii != 0 && ii == identifiers.length - 1) {
                                        Iterable iter = iter(tupleInit.valueAt(ii), null/**TODO i.getInitValueConstraint()*/);
                                ...
                                Iterable iterOfTuples = iter(initValue, null/**TODO i2.getInitValueConstraint()*/);
...
//                    }
                    ...
                    case ARRAY: {
                        ...
                        JType t = context.getContext().types().typeOf(v);
            ...
            case H_ARRAY_NEW: {
                ...
                JType arrayType =  a.getArrayType();
                ...
                if (a.getConstructor() != null) {
                    ...
                    if (setter instanceof HNDeclareInvokable) {
                        ...
                        switch (arrayType.arrayDimension()) {
                            ...
                            case 3: {
                                JType tt = arrayType;
                                JType tt1 =  arrayType.componentType();
                                for (int i = 0; i < allLen[0]; i++) {
                                    JArray jarr1 = tt.asArray(jarr0.get(i));
                                    for (int j = 0; j < allLen[1]; j++) {
            ...
            case H_META_IMPORT_PACKAGE: {
                ...
                Object instance = context.getInstance().getValue();
                if (!(instance instanceof HCompilerEnv)) {
                    throw new JEvalException("No Compiler in context");
                }
                HCompilerEnv ce = (HCompilerEnv) instance;
                ...
                ce.addDependency(new HDependency(
                        p, a.getScope(),
                        a.isOptional(),
                        ...
                        Object proxy = Proxy.newProxyInstance(getClass().getClassLoader(),
                                new Class[]{
                                    ...
                                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                                        if (method.getName().equals(lnode.getTargetMethod().getName())) {
    ...
    private Tuple2<Object,Object> evalArrayInc(HNBracketsPostfix arg, int inc, JInvokeContext context) {
        ...
        JType arrayType =  a.getLeft().getElement().getType();
