...
\textit{HadraLang} supports byte, short, int, long and bigint (BigInteger) numerical ordinal types out of the box.

%            \subsubsection{int Type}
...
\textit{HadraLang} supports short, long and bigdecimal (BigDecimal) numerical floating types out of the box.
